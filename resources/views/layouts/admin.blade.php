...
<body>
    ...
    <nav class="flex justify-between w-full p-2">
        ...
        <div class="flex text-sm">
            <a class="flex items-center justify-between p-4 text-sm font-semibold text-purple-100 bg-purple-600 hover:bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
  ...
  let languages = {
    'en': 'https://cdn.datatables.net/plug-ins/1.10.19/i18n/Swedish.json'
  };
