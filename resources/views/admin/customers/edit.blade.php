...
<div class="main-card">
    ...
    <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
        ...
        <div class="body">
            ...
            <div class="mb-3">
                <label for="company" class="text-xs required">Företag</label>
            ...
            <div class="mb-3">
                <label for="org_number" class="text-xs required">Org_nummer</label>
            ...
            <div class="mb-3">
                <label for="SSN" class="text-xs required">Personnummer</label>
            ...
            <div class="mb-3">
                <label for="ZIP_Code" class="text-xs required">Post_nummer</label>
            ...
            <div class="mb-3">
                <label for="residence" class="text-xs required">Ort</label>
            ...
            <div class="mb-3">
                <label for="users" class="text-xs">Anställda</label>
