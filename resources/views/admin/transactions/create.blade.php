    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="product_id">{{ trans('cruds.transaction.fields.product') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.transaction.fields.product_helper') }}</span>
            </div>
            <div class="form-group">
